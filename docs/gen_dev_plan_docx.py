...
OUTPUT_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "项目开发计划书_v4.docx")
...
def generate_document():
    ...
    add_styled_paragraph(
        doc,
        "基于需求分析，项目规划 5 大模块共 24 个功能点。以下为完整功能规划：",
        first_line_indent=0.74,
    )
    ...
    # 吃喝模块
    add_heading_styled(doc, "吃喝模块（6 个功能）", level=3)
    create_table(doc,
        ["序号", "功能", "说明", "优先级"],
        [
            ...
            ["5", "校园卡/水卡/网费总览", "实时查看一卡通余额与消费记录、水卡余额、校园网剩余时长与网费", "P1"],
            ["6", "生活预算规划", "根据月预算 + 校内餐饮价格库（食堂/奶茶店/便利店等）+ 卡余额，AI 生成每日消费建议与预算预警", "P1"],
        ],
        col_widths=[1.2, 4, 8, 2],
    )
    ...
    create_table(doc,
        ...
        [
            ...
            ["校园一卡通系统", "一卡通余额、消费记录、水卡余额", "HTTP 爬虫 / 校园卡 API"],
            ["校园网管理系统", "校园网剩余时长、网费余额", "HTTP 爬虫"],
    ...
    create_table(doc,
        ...
        [
            ...
            ["校园卡/水卡/网费系统对接调研", "Team B 后端", "接口可行性报告"],
    ...
    create_table(doc,
        ...
        [
            ...
            ["校园卡/水卡/网费余额查询", "Team B", "多系统数据对接 + 余额总览页面"],
            ["生活预算规划（餐饮价格库 + AI 预算建议）", "Team B + AI 组", "餐饮定价采集 + 预算算法 + 预警推送"],
